      ...
      <section className={styles.features}>
          ...
          <div className={clsx('row', styles.blockStyling)}>
                ...
                <div className="row">
                  ...
                  <div className={clsx('col', styles.blockText)}>
                    <ul>
                      ...
                      <li>
                        <p>
                          Prompt the user to restart their computer if required, immediately, on a timer and with a
                          deadline
                        </p>
                      </li>
                    </ul>
            ...
            <div className="col col--5">
              <img
                ...
                src="/images/features-worker-male-longbeard.svg"
        ...
        <div className="container">
          <div className={clsx('row', styles.blockStyling)}>
            ...
            <div className="col col--7">
              ...
              <p className={styles.blockText}>
                That stability is exactly why PSAppDeployToolkit is used by Fortune 500 companies and federal
                governments, banks, globally recognized brands, white-label packaging factories, defence contractors and
                military, in-house IT teams, consultants and managed service providers to deploy applications on
                millions of Windows endpoints all over the world every day.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={clsx('container', styles.capabilitiesContainer)}>
          <h2 className={styles.blockTitle}>
            <span className={styles.logoThickText}>Capability and Feature</span> Details
          </h2>
              ...
              <div className="col col--6">
                <div>
                  <div className={styles.featureText}>
                    <ul>
                      <li>
                        Pre-built functions come with automated logging - so you can quickly find problems in your
                        scripts if they occur.
                      </li>
                      <li>
                        Provides the ability to execute any type of setup (Windows Installer or Executable-based) with
                        automated exit code handling, as well as MSI-based installers having their logs captured and
                        stored alongside PSAppDeployToolkit logs.
                      </li>
                      <li>
                      ...
                      <li>
                        Perform MCM actions such as Machine and User Policy Refresh, Inventory Update and Software
                        Update
                      </li>
              ...
              <div className="col col--6">
                <div>
                  <div className={styles.featureText}>
                    <ul>
                      <li>
                        Handles MCM exit codes, including time sensitive dialogs supporting *MCM Fast Retry* - providing
                        more accurate Reporting (no more Failed due to timeout errors).
                      </li>
                      <li>
                        Ability to prevent reboot codes (3010) from being passed back to MCM, which would cause a reboot
                        prompt.
                      </li>
                      <li>
                        Supports the MCM application model by providing an install and uninstall deployment type for
              ...
              <div className="col col--6">
                <div>
                  <div className={styles.featureText}>
                    <ul>
                      <li>
                        Bundle multiple application installations to overcome the supported limit of 5 applications in
                        the MCM application dependency chain.
                      </li>
                      <li>
                        Compared to compiled deployment packages, e.g. WiseScript, PSAppDeployToolkit utilizes the
                        Microsoft Endpoint Configuration Management cache correctly and MCM Distribution Point bandwidth
                        more efficiently by using loose files.
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div className={styles.featureText}>
                    <ul>
                      <li>
                        ...
                        the application deployment. The user is prompted to save their documents and has the option to
                        close the programs themselves, have PSAppDeployToolkit close the programs, or optionally defer.
                        Optionally, a countdown can be displayed until the applications are automatically closed.
                      </li>
                      <li>
                        The ability to allow the user to defer an installation X number of times, X number of days or
                        until a deadline date is reached.
                      </li>
                      <li>
                ...
                <div>
                  <div className={styles.featureText}>
                    <ul>
                      ...
                      <li>
                        Balloon tip notifications to indicate the beginning and end of an installation and the success
                      ...
                      <li>
                        ...
                        running MCM task sequence or session 0).
                      </li>
                      <li>
