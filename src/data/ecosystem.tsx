...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    type: 'commercial',
    description: 'Graphical No-Code / Low-Code package authoring. Convert Ivanti DSM packages to PowerShell. Automate Winget package creation.',
  ...
  },
  {
    ...
    type: 'commercial',
    description: 'PSADT - Package Forge offers an efficient and modern solution for anyone who wants to create PSAppDeployToolkit packages quickly, reliably, and to the highest quality standards.', // The text portion 'PSADT - Package Forge' is the precise vendor spelling as per their website. The description text deliberately differs from the "name" property.
    worksWith: ['Standalone', 'Intune'],
