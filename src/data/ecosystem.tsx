...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    type: 'commercial',
    description: 'PSADT - Package Forge offers an efficient and modern solution for anyone who wants to create PSAppDeployToolkit packages quickly, reliably, and to the highest quality standards.', // Text matches 1:1 with the blurb on https://www.psadt-packageforge.com/
    worksWith: ['Standalone', 'Intune'],
