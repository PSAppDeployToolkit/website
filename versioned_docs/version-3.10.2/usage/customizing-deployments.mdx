...
To brand the PSAppDeployToolkit UI prompts with your own custom/corporate banner, replace the `AppDeployToolkitBanner.png` file with your own .png file (retaining the file name). The file must be in PNG format and should be 450 x 50 in size.
