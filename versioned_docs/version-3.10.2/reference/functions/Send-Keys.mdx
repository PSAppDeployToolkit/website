...
id: Send-Keys
title: Send-Keys
description: Help page for the "Send-Keys" command
keywords:
  - PSAppDeployToolkit
  - PowerShell
  - Help
...
https://psappdeploytoolkit.com](http://msdn.microsoft.com/en-us/library/System.Windows.Forms.SendKeys(v=vs.100).aspx
