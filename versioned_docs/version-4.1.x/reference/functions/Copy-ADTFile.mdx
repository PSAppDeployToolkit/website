...
Copy-ADTFile [-Path] <String[]> [-Destination] <String> [-Recurse] [-Flatten] [-ContinueFileCopyOnError]
 [-FileCopyMode <String>] [-RobocopyParams <String>] [-RobocopyAdditionalParams <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Copy-ADTFile [-LiteralPath] <String[]> [-Destination] <String> [-Recurse] [-Flatten] [-ContinueFileCopyOnError]
 [-FileCopyMode <String>] [-RobocopyParams <String>] [-RobocopyAdditionalParams <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
