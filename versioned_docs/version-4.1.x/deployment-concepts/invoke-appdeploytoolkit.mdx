...
If trying to use a PSAppDeployToolkit variable such as $envProgramFiles in this section, it will not work because the module has typically not been imported and initialized this early on in the script.
:::
