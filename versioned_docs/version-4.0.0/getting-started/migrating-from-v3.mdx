...
Before proceeding, ensure that you have reviewed the numerous [changes](/docs/getting-started/changes-in-v4) in v4.

## Using v4 in v3 Compatibility Mode

See the [Creating a new deployment](/docs/getting-started/creating-a-new-deployment) page for instructions on creating a v3-compatible deployment template or downloading one from GitHub.
...
The [Downloading](/docs/getting-started/download) page covers how to download and install this additional module.
