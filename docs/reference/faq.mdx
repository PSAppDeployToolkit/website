...
<details>
  ...
  Future enahncements are planned where the installation status of an MSI can be tested before attempting to uninstall it. Until then, you can use the `-IgnoreExitCodes` parameter with `Uninstall-ADTApplication` to ignore this error code.
</details>
