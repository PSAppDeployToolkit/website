---
id: Get-ADTModuleCallback
title: Get-ADTModuleCallback
hide_title: false
...
```powershell
Get-ADTModuleCallback [-Hookpoint] <CallbackType> [<CommonParameters>]
```
...
[https://psappdeploytoolkit.com/docs/reference/functions/Get-ADTModuleCallback](https://psappdeploytoolkit.com/docs/reference/functions/Get-ADTModuleCallback)

[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Get-ADTModuleCallback.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Get-ADTModuleCallback.ps1)
