...
When the `-UseCIM` parameter is provided, a Win32_Service or Win32_BaseService `CimInstance` is returned.
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Test-ADTServiceExists.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Test-ADTServiceExists.ps1)
