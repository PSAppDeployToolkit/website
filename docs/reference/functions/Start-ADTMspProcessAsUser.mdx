...
Start-ADTMspProcessAsUser [[-Username] <NTAccount>] [-FilePath] <String> [[-AdditionalArgumentList] <String[]>]
 [[-LoggingOptions] <String>] [[-LogFileName] <String>] [-UseLinkedAdminToken] [-UseHighestAvailableToken]
 [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables] [-DenyUserTermination] [<CommonParameters>]
```
