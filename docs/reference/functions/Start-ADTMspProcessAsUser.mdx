...
```powershell
Start-ADTMspProcessAsUser [-FilePath] <String> [[-AdditionalArgumentList] <String[]>] [[-Username] <NTAccount>]
 [-UseLinkedAdminToken] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables] [<CommonParameters>]
```
