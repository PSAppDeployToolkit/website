...
Uninstall-ADTApplication -InstalledApplication <InstalledApplication[]> [-ArgumentList <String>]
 ...
 [-RebootExitCodes <Int32[]>] [-ExitOnProcessFailure] [-PassThru] [<CommonParameters>]
```
...
Uninstall-ADTApplication [-Name <String[]>] [-NameMatch <String>] [-ProductCode <Guid[]>]
 ...
 [-LogFileName <String>] [-WaitForChildProcesses] [-KillChildProcessesWithParent] [-SuccessExitCodes <Int32[]>]
 [-RebootExitCodes <Int32[]>] [-ExitOnProcessFailure] [-PassThru] [<CommonParameters>]
```
