...
```powershell
Get-ADTWindowTitle [[-WindowTitle] <String>] [[-WindowHandle] <IntPtr[]>] [[-ParentProcess] <String[]>]
 [[-ParentProcessId] <UInt32[]>] [[-ParentProcessMainWindowHandle] <IntPtr[]>] [<CommonParameters>]
```
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Get-ADTWindowTitle.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Get-ADTWindowTitle.ps1)
