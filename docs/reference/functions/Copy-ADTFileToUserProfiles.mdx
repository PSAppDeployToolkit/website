...
### PathCalculatedProfiles (Default)
...
Copy-ADTFileToUserProfiles [-Path] <String[]> [[-Destination] <String>] [-BasePath <String>] [-Recurse]
 ...
 [-RobocopyAdditionalParams <String>] [-ExcludeNTAccount <String[]>] [-IncludeSystemProfiles]
 [-IncludeServiceProfiles] [-ExcludeDefaultUser] [-ContinueFileCopyOnError] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### PathSpecifiedProfiles

```powershell
Copy-ADTFileToUserProfiles [-Path] <String[]> [[-Destination] <String>] [-BasePath <String>] [-Recurse]
 [-Flatten] [-NoClobber] [-FileCopyMode <String>] [-RobocopyParams <String>]
 [-RobocopyAdditionalParams <String>] -UserProfiles <UserProfileInfo[]> [-ContinueFileCopyOnError] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### LiteralPathSpecifiedProfiles
...
```yaml
Type: String[]
Parameter Sets: PathCalculatedProfiles, PathSpecifiedProfiles
Aliases:
...
```yaml
Type: String[]
Parameter Sets: LiteralPathSpecifiedProfiles, LiteralPathCalculatedProfiles
Aliases:
...
Parameter Sets: PathSpecifiedProfiles, LiteralPathSpecifiedProfiles
Aliases:
...
```yaml
Type: String[]
Parameter Sets: PathCalculatedProfiles, LiteralPathCalculatedProfiles
Aliases:
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Copy-ADTFileToUserProfiles.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Copy-ADTFileToUserProfiles.ps1)
