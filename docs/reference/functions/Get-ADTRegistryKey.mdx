...
```powershell
Get-ADTRegistryKey -Path <String> [-Name <String>] [-Wow6432Node] [-SID <String>] [-ReturnEmptyKeyIfExists]
 [-DoNotExpandEnvironmentNames] [<CommonParameters>]
```

### LiteralPath

```powershell
Get-ADTRegistryKey -LiteralPath <String> [-Name <String>] [-Wow6432Node] [-SID <String>]
