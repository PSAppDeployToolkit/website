...
The `Show-ADTDialogBox` function displays a custom dialog box with optional title, buttons, icon, and timeout.
...
Valid values for this parameter are: `First`, `Second`, `Third`.
...
Valid values for this parameter are: `None`, `Stop`, `Question`, `Exclamation`, `Information`.

```yaml
Type: DialogBoxIcon
Parameter Sets: (All)
Aliases:
Accepted values: Stop, Question, Exclamation, Information
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Show-ADTDialogBox.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Show-ADTDialogBox.ps1)
