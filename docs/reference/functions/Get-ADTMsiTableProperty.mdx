...
Get-ADTMsiTableProperty -LiteralPath <String> [-TransformPath <String[]>] [-Table <String>]
 [-TablePropertyNameColumnNum <UInt32>] [-TablePropertyValueColumnNum <UInt32>] [<CommonParameters>]
```
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/src/PSAppDeployToolkit/Public/Get-ADTMsiTableProperty.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/src/PSAppDeployToolkit/Public/Get-ADTMsiTableProperty.ps1)
