...
Open-ADTSession [[-SessionState] <SessionState>] [[-DeploymentType] <DeploymentType>]
 [[-DeployMode] <DeployMode>] [-SuppressRebootPassThru] [-TerminalServerMode] [-DisableLogging]
 ...
 [[-AppSuccessExitCodes] <Int32[]>] [[-AppRebootExitCodes] <Int32[]>]
 [[-AppProcessesToClose] <ProcessDefinition[]>] [-RequireAdmin] [[-ScriptDirectory] <String[]>]
 ...
 [-PassThru] [[-LogName] <String>] [[-AdditionalEnvironmentVariables] <IDictionary>] [[-SessionClass] <Type>]
