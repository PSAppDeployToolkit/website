...
Open-ADTSession [[-SessionState] <SessionState>] [[-DeploymentType] <DeploymentType>]
 ...
 [-NoSessionDetection] [-NoOobeDetection] [-NoProcessDetection] [-PassThru] [[-LogName] <String>]
 [[-SessionClass] <Type>] [[-UnboundArguments] <System.Collections.Generic.IReadOnlyList`1[System.Object]>]
 [<CommonParameters>]
```
...
Required: False
Position: 1
Default value: $PSCmdlet.SessionState
...
Specifies an override for PSAppDeployToolkit.SessionManagement.DeploymentSession class.
...
Required: False
Position: 28
Default value: PSAppDeployToolkit.SessionManagement.DeploymentSession
Accept pipeline input: False
Accept wildcard characters: False
```
