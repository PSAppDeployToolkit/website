...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 ...
 [-UseHighestAvailableToken] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables] [-CreateNoWindow]
...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] -RunAsActiveUser <RunAsActiveUser> [-UseLinkedAdminToken]
 [-UseHighestAvailableToken] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables] [-WaitForMsiExec]
