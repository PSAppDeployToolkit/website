...
```powershell
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] -Username <NTAccount> [-UseLinkedAdminToken] [-UseHighestAvailableToken]
 [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables] [-CreateNoWindow] [-StreamEncoding <Encoding>]
 [-NoStreamLogging] [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>] [-WaitForChildProcesses]
...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] -Username <NTAccount> [-UseLinkedAdminToken] [-UseHighestAvailableToken]
 [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables] -WindowStyle <ProcessWindowStyle>
...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] -Username <NTAccount> [-UseLinkedAdminToken] [-UseHighestAvailableToken]
 [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables] [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>]
...
```yaml
Type: Int32[]
Parameter Sets: Default_CreateWindow_Wait, Username_CreateNoWindow_Timeout, Username_CreateNoWindow_Wait, Username_WindowStyle_Timeout, Username_WindowStyle_Wait, Username_CreateWindow_Timeout, Username_CreateWindow_Wait, Default_CreateNoWindow_Timeout, Default_CreateNoWindow_Wait, Default_WindowStyle_Timeout, Default_WindowStyle_Wait, Default_CreateWindow_Timeout, UseShellExecute_CreateNoWindow_Timeout, UseShellExecute_CreateNoWindow_Wait, UseShellExecute_WindowStyle_Timeout, UseShellExecute_WindowStyle_Wait, UseShellExecute_CreateWindow_Timeout, UseShellExecute_CreateWindow_Wait
Aliases:
...
Where possible, please use `-SuccessExitCodes` and/or `-RebootExitCodes` instead.
