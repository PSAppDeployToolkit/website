...
Start-ADTMsiProcess [-Action <String>] -FilePath <String> [-ArgumentList <String[]>]
 ...
 [-ExitOnProcessFailure] [-NoDesktopRefresh] [-NoWait] [-PassThru] [<CommonParameters>]
```
...
```yaml
Type: String
Parameter Sets: UseUnelevatedToken_FilePath, Username_FilePath, FilePath
Aliases:
...
```yaml
Type: Guid
Parameter Sets: UseUnelevatedToken_ProductCode, Username_ProductCode, ProductCode
Aliases:
...
Parameter Sets: UseUnelevatedToken_InstalledApplication, Username_InstalledApplication, InstalledApplication
Aliases:
...
```yaml
Type: NTAccount
Parameter Sets: Username_FilePath, Username_ProductCode, Username_InstalledApplication
Aliases:
...
```yaml
Type: SwitchParameter
Parameter Sets: UseUnelevatedToken_FilePath, UseUnelevatedToken_ProductCode, UseUnelevatedToken_InstalledApplication
Aliases:
