...
The amount of time the current thread should wait to acquire an exclusive lock of a named mutex.
...
[https://psappdeploytoolkit.com/docs/reference/functions/Test-ADTMutexAvailability](https://psappdeploytoolkit.com/docs/reference/functions/Test-ADTMutexAvailability)

[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Test-ADTMutexAvailability.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Test-ADTMutexAvailability.ps1)
