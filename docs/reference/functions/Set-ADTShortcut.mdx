...
Set-ADTShortcut [-LiteralPath] <String> [-TargetPath <String>] [-Arguments <String>] [-IconLocation <String>]
 ...
 [-WindowStyle <ShortcutWindowStyle>] [-RunAsAdmin] [-Hotkey <String>] [-Clear <String[]>] [-Force] [-PassThru]
...
Set-ADTShortcut -InputObject <IShortcutLinkInfo> [-TargetPath <String>] [-Arguments <String>]
 ...
 [-WindowStyle <ShortcutWindowStyle>] [-RunAsAdmin] [-Hotkey <String>] [-Clear <String[]>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION

The `Set-ADTShortcut` function modifies a .lnk or .url shortcut file, with the configured options.
...
Specifies that the command executed by the shortcut should be done so with elevated permissions.
Setting this option will prompt the user to elevate when the shortcut is executed.
...
Clears one or more shortcut properties.
Only clears if the corresponding parameter isn't specified.
...
Url shortcuts support TargetPath, IconLocation, IconIndex, Description and Hotkey.
Other parameters are ignored: an internet shortcut has nowhere to keep them.
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Set-ADTShortcut.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Set-ADTShortcut.ps1)
