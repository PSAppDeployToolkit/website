---
id: Get-ADTLoggedOnUser
title: Get-ADTLoggedOnUser
hide_title: false
...
It provides basic information about the logged on user's account and logon session.
...
- `WTSActive`: A user is logged on to the session.
...
- `WTSDisconnected`: The session is active but the client is disconnected.
...
- `WTSListen`: The session is listening for a connection.
...
[https://psappdeploytoolkit.com/docs/reference/functions/Get-ADTLoggedOnUser](https://psappdeploytoolkit.com/docs/reference/functions/Get-ADTLoggedOnUser)

[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Get-ADTLoggedOnUser.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Get-ADTLoggedOnUser.ps1)
