...
description: 'Unblocks the execution of applications performed by the Block-ADTAppExecution function.'
keywords:
  - PSADT
  - PSAppDeployToolkit
  - PowerShell
...
```powershell
Unblock-ADTAppExecution [[-Tasks] <CimInstance[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
