...
Show-ADTInstallationRestartPrompt [-CountdownSeconds <UInt32>] [-CountdownNoHideSeconds <UInt32>]
 [-WindowLocation <DialogPosition>] [-CustomText] [-NotTopMost] [-AllowMove] -Title <String> -Subtitle <String>
 [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationRestartPrompt [-NoCountdown] [-WindowLocation <DialogPosition>] [-CustomText] [-NotTopMost]
 [-AllowMove] -Title <String> -Subtitle <String> [<CommonParameters>]
```
