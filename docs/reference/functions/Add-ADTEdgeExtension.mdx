...
Add-ADTEdgeExtension [-ExtensionID] <String> [-UpdateUrl] <String> [-InstallationMode] <String>
 [[-MinimumVersionRequired] <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://psappdeploytoolkit.com/docs/reference/functions/Add-ADTEdgeExtension](https://psappdeploytoolkit.com/docs/reference/functions/Add-ADTEdgeExtension)

[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Add-ADTEdgeExtension.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Add-ADTEdgeExtension.ps1)
