...
Show-ADTInstallationPrompt -Message <String> [-MessageAlignment <DialogMessageAlignment>]
 [-ButtonRightText <String>] [-ButtonLeftText <String>] [-ButtonMiddleText <String>]
 [-DefaultButton <DialogDefaultButton>] [-Icon <DialogSystemIcon>] [-WindowLocation <DialogPosition>] [-NoWait]
 [-PersistPrompt] [-MinimizeWindows] [-NoExitOnTimeout] [-NotTopMost] [-AllowMove] [-Force] -Title <String>
 -Subtitle <String> [-Timeout <TimeSpan>] [<CommonParameters>]
```

### ShowSecureInputDialog
...
Show-ADTInstallationPrompt [-RequestInput] [-SecureInput] -Message <String>
 ...
 [-ButtonMiddleText <String>] [-DefaultButton <DialogDefaultButton>] [-Icon <DialogSystemIcon>]
 [-WindowLocation <DialogPosition>] [-PersistPrompt] [-MinimizeWindows] [-NoExitOnTimeout] [-NotTopMost]
 [-AllowMove] [-Force] -Title <String> -Subtitle <String> [-Timeout <TimeSpan>] [<CommonParameters>]
```
...
Show-ADTInstallationPrompt [-RequestInput] -Message <String> [-MessageAlignment <DialogMessageAlignment>]
 [-ButtonRightText <String>] [-ButtonLeftText <String>] [-ButtonMiddleText <String>]
 [-DefaultButton <DialogDefaultButton>] [-Icon <DialogSystemIcon>] [-WindowLocation <DialogPosition>]
 [-PersistPrompt] [-MinimizeWindows] [-NoExitOnTimeout] [-NotTopMost] [-AllowMove] [-Force] -Title <String>
 -Subtitle <String> [-Timeout <TimeSpan>] [<CommonParameters>]
```
...
Show-ADTInstallationPrompt -Message <String> [-MessageAlignment <DialogMessageAlignment>]
 [-ButtonRightText <String>] [-ButtonLeftText <String>] [-ButtonMiddleText <String>]
 [-DefaultButton <DialogDefaultButton>] [-Icon <DialogSystemIcon>] -ListItems <String[]>
 [-DefaultIndex <UInt32>] [-WindowLocation <DialogPosition>] [-NoWait] [-PersistPrompt] [-MinimizeWindows]
 [-NoExitOnTimeout] [-NotTopMost] [-AllowMove] [-Force] -Title <String> -Subtitle <String>
 [-Timeout <TimeSpan>] [<CommonParameters>]
```

## DESCRIPTION

The `Show-ADTInstallationPrompt` function displays a custom installation prompt with the toolkit branding and optional buttons.
...
Parameter Sets: ShowSecureInputDialog, ShowInputDialog_DefaultValue, ShowInputDialog
Aliases:
...
Changes the returned type to `SecureInputDialogResult`, whose `Text` property is a `System.Security.SecureString` rather than a string.
The value is protected across the client/server boundary by the encrypted channel the two processes negotiate; it cannot be carried as a `SecureString` itself, because that type's memory protection is scoped to the process that created it.

Requires the Fluent dialog style, as `-RequestInput` does on its own.
Under `DialogStyle = Classic` the dialog throws at runtime, since an input dialog is only implemented for Fluent.

```yaml
Type: SwitchParameter
Parameter Sets: ShowSecureInputDialog
Aliases:
...
```yaml
Type: DialogDefaultButton
Parameter Sets: (All)
Aliases:
Accepted values: None, Left, Middle, Right
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Show-ADTInstallationPrompt.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Show-ADTInstallationPrompt.ps1)
