...
Show-ADTInstallationPrompt -Message <String> [-MessageAlignment <DialogMessageAlignment>]
 ...
 -Subtitle <String> [-Timeout <UInt32>] [<CommonParameters>]
```
...
Show-ADTInstallationPrompt -Message <String> [-MessageAlignment <DialogMessageAlignment>]
 ...
 [-NoExitOnTimeout] [-NotTopMost] [-AllowMove] [-Force] -Title <String> -Subtitle <String> [-Timeout <UInt32>]
 [<CommonParameters>]
```
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/src/PSAppDeployToolkit/Public/Show-ADTInstallationPrompt.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/src/PSAppDeployToolkit/Public/Show-ADTInstallationPrompt.ps1)
