...
```powershell
Convert-ADTRegistryPath [-Key] <String> [[-SID] <SecurityIdentifier>] [-Wow6432Node] [<CommonParameters>]
```
...
[https://psappdeploytoolkit.com/docs/reference/functions/Convert-ADTRegistryPath](https://psappdeploytoolkit.com/docs/reference/functions/Convert-ADTRegistryPath)

[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Convert-ADTRegistryPath.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Convert-ADTRegistryPath.ps1)
