...
description: 'Convert between NT Account names and their security identifiers (SIDs).'
keywords:
  - PSADT
  - PSAppDeployToolkit
  - PowerShell
...
```powershell
ConvertTo-ADTNTAccountOrSID -WellKnownSIDName <WellKnownSidType> [-WellKnownToNTAccount] [<CommonParameters>]
```
...
Parameter Sets: WellKnownNameLocalHost, WellKnownNameLdap, WellKnownName
Aliases:
...
```yaml
Type: String
Parameter Sets: WellKnownNameLdap
Aliases:
