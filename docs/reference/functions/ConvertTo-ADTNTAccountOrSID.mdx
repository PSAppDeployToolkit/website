...
```powershell
ConvertTo-ADTNTAccountOrSID -WellKnownSIDName <WellKnownSidType> [-WellKnownToNTAccount] [-LdapUri <String>]
 [<CommonParameters>]
```
...
Parameter Sets: WellKnownNameLocalHost, WellKnownName
Aliases:
...
```yaml
Type: SwitchParameter
Parameter Sets: WellKnownNameLocalHost
Aliases:
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/ConvertTo-ADTNTAccountOrSID.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/ConvertTo-ADTNTAccountOrSID.ps1)

[https://learn.microsoft.com/en-us/dotnet/api/system.security.principal.wellknownsidtype](https://learn.microsoft.com/en-us/dotnet/api/system.security.principal.wellknownsidtype)
