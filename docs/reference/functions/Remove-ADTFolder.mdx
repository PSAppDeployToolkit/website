...
```powershell
Remove-ADTFolder -Path <String[]> [-DisableRecursion] [<CommonParameters>]
```

### LiteralPath

```powershell
Remove-ADTFolder -LiteralPath <String[]> [-DisableRecursion] [<CommonParameters>]
```

### InputObject

```powershell
Remove-ADTFolder -InputObject <DirectoryInfo> [-DisableRecursion] [<CommonParameters>]
```
