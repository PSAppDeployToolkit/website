...
New-ADTZipFile -Path <String[]> -DestinationPath <String> [-CompressionLevel <String>] [-Update] [-Force]
 [-RemoveSourceAfterArchiving] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
New-ADTZipFile -LiteralPath <String[]> -DestinationPath <String> [-CompressionLevel <String>] [-Update]
 [-Force] [-RemoveSourceAfterArchiving] [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION

The `New-ADTZipFile` function creates a new zip archive or adds content to an existing archive by using PowerShell's `Compress-Archive`.
...
- `Fastest`: Use the fastest compression method available to reduce processing time.
Faster compression can result in larger file sizes.
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/New-ADTZipFile.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/New-ADTZipFile.ps1)
