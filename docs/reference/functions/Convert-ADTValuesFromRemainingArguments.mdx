...
description: 'Converts the collected values from a ValueFromRemainingArguments parameter value into a dictionary or PowerShell.exe command line arguments.'
keywords:
  - PSADT
  - PSAppDeployToolkit
  - PowerShell
