...
Start-ADTProcessAsUser [-Username <NTAccount>] -FilePath <String> [-ArgumentList <String[]>]
 ...
 [-DenyUserTermination] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables] [-WaitForMsiExec]
 ...
 [-PriorityClass <ProcessPriorityClass>] [-ExitOnProcessFailure] [-ContinueWhenNoUserLoggedOn] [-PassThru]
...
Start-ADTProcessAsUser [-Username <NTAccount>] -FilePath <String> [-ArgumentList <String[]>]
 [-SecureArgumentList] [-WorkingDirectory <String>] [-UseLinkedAdminToken] [-UseHighestAvailableToken]
 [-DenyUserTermination] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables] [-CreateNoWindow]
 [-StreamEncoding <Encoding>] [-StandardInput <String[]>] [-NoStreamLogging] [-WaitForMsiExec]
 ...
 [-ExitOnProcessFailure] [-ContinueWhenNoUserLoggedOn] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Start-ADTProcessAsUser [-Username <NTAccount>] -FilePath <String> [-ArgumentList <String[]>]
 ...
 [-StreamEncoding <Encoding>] [-StandardInput <String[]>] [-NoStreamLogging] [-WaitForMsiExec]
 [-MsiExecWaitTime <TimeSpan>] [-WaitForChildProcesses] [-KillChildProcessesWithParent]
 [-PriorityClass <ProcessPriorityClass>] [-ContinueWhenNoUserLoggedOn] [-NoWait] [-PassThru] [-WhatIf]
...
Start-ADTProcessAsUser [-Username <NTAccount>] -FilePath <String> [-ArgumentList <String[]>]
 [-SecureArgumentList] [-WorkingDirectory <String>] [-UseLinkedAdminToken] [-UseHighestAvailableToken]
 [-DenyUserTermination] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables]
 ...
 [-ContinueWhenNoUserLoggedOn] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Start-ADTProcessAsUser [-Username <NTAccount>] -FilePath <String> [-ArgumentList <String[]>]
 ...
 [-DenyUserTermination] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables]
 -WindowStyle <ProcessWindowStyle> [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>] [-WaitForChildProcesses]
 [-KillChildProcessesWithParent] [-PriorityClass <ProcessPriorityClass>] [-ContinueWhenNoUserLoggedOn]
...
```powershell
Start-ADTProcessAsUser [-Username <NTAccount>] -FilePath <String> [-ArgumentList <String[]>]
 [-SecureArgumentList] [-WorkingDirectory <String>] [-ExpandEnvironmentVariables] [-UseShellExecute]
 [-Verb <String>] [-CreateNoWindow] [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>] [-WaitForChildProcesses]
 [-KillChildProcessesWithParent] [-PriorityClass <ProcessPriorityClass>] [-ContinueWhenNoUserLoggedOn]
 [-NoWait] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Start-ADTProcessAsUser [-Username <NTAccount>] -FilePath <String> [-ArgumentList <String[]>]
 [-SecureArgumentList] [-WorkingDirectory <String>] [-ExpandEnvironmentVariables] [-UseShellExecute]
 [-Verb <String>] -WindowStyle <ProcessWindowStyle> [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>]
 [-WaitForChildProcesses] [-KillChildProcessesWithParent] [-PriorityClass <ProcessPriorityClass>]
 [-ContinueWhenNoUserLoggedOn] [-NoWait] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Start-ADTProcessAsUser [-Username <NTAccount>] -FilePath <String> [-ArgumentList <String[]>]
 [-SecureArgumentList] [-WorkingDirectory <String>] [-ExpandEnvironmentVariables] [-UseShellExecute]
 [-Verb <String>] [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>] [-WaitForChildProcesses]
 [-KillChildProcessesWithParent] [-PriorityClass <ProcessPriorityClass>] [-ContinueWhenNoUserLoggedOn]
 [-NoWait] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
If the file is in a subdirectory of "Files", use the `$($adtSession.DirFiles)` variable, as shown in the example.
...
The `-WorkingDirectory` parameter behaves differently depending on the value of the `-UseShellExecute` parameter.
When `-UseShellExecute` is `$true`, the `-WorkingDirectory` parameter specifies the location of the executable.
When `-UseShellExecute` is `$false`, the `-WorkingDirectory` parameter is not used to find the executable.
...
```yaml
Type: SwitchParameter
Parameter Sets: UseShellExecute_CreateNoWindow_NoWait, UseShellExecute_CreateNoWindow_Wait, UseShellExecute_WindowStyle_NoWait, UseShellExecute_WindowStyle_Wait, UseShellExecute_CreateWindow_NoWait, UseShellExecute_CreateWindow_Wait
Aliases:
...
Parameter Sets: Default_WindowStyle_Timeout, Default_WindowStyle_NoWait, Default_WindowStyle_Wait, UseShellExecute_WindowStyle_NoWait, UseShellExecute_WindowStyle_Wait
Aliases:
...
```yaml
Type: SwitchParameter
Parameter Sets: Default_CreateNoWindow_Timeout, Default_CreateNoWindow_NoWait, Default_CreateNoWindow_Wait, UseShellExecute_CreateNoWindow_NoWait, UseShellExecute_CreateNoWindow_Wait
Aliases:
...
Specifies the encoding type to use when reading stdin/stdout/stderr.
...
Specifies a string to write to the process's stdin stream.
This is handy for answering known prompts, etc.
...
Specify the length of time to wait for the msiexec engine to become available.
...
Specifies whether any child processes started by the provided executable should be closed when the provided executable closes.
This is handy for application installs that open web browsers and other programs that cannot be suppressed.
...
```yaml
Type: TimeSpan
Parameter Sets: Default_CreateNoWindow_Timeout, Default_WindowStyle_Timeout, Default_CreateWindow_Timeout
Aliases:
...
```yaml
Type: Int32[]
Parameter Sets: Default_CreateWindow_Wait, Default_CreateNoWindow_Timeout, Default_CreateNoWindow_Wait, Default_WindowStyle_Timeout, Default_WindowStyle_Wait, Default_CreateWindow_Timeout, UseShellExecute_CreateNoWindow_Wait, UseShellExecute_WindowStyle_Wait, UseShellExecute_CreateWindow_Wait
Aliases:
...
```yaml
Type: SwitchParameter
Parameter Sets: Default_CreateNoWindow_NoWait, Default_WindowStyle_NoWait, Default_CreateWindow_NoWait, UseShellExecute_CreateNoWindow_NoWait, UseShellExecute_WindowStyle_NoWait, UseShellExecute_CreateWindow_NoWait
Aliases:
...
[https://psappdeploytoolkit.com/docs/reference/functions/Start-ADTProcessAsUser](https://psappdeploytoolkit.com/docs/reference/functions/Start-ADTProcessAsUser)

[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Start-ADTProcessAsUser.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Start-ADTProcessAsUser.ps1)
