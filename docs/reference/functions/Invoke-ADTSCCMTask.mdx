...
The `Invoke-ADTSCCMTask` function triggers Configuration Manager/SCCM to invoke the requested schedule task ID.
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Invoke-ADTSCCMTask.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Invoke-ADTSCCMTask.ps1)
