...
```powershell
Start-ADTMspProcess -FilePath <String> [-AdditionalArgumentList <String[]>] [-LoggingOptions <String>]
 [-LogFileName <String>] [-ExpandEnvironmentVariables] [<CommonParameters>]
```
...
```powershell
Start-ADTMspProcess -FilePath <String> [-AdditionalArgumentList <String[]>] [-LoggingOptions <String>]
 [-LogFileName <String>] -RunAsActiveUser <RunAsActiveUser> [-UseLinkedAdminToken] [-UseHighestAvailableToken]
 [-InheritEnvironmentVariables] [-DenyUserTermination] [-ExpandEnvironmentVariables] [<CommonParameters>]
```
...
```powershell
Start-ADTMspProcess -FilePath <String> [-AdditionalArgumentList <String[]>] [-LoggingOptions <String>]
 [-LogFileName <String>] [-UseUnelevatedToken] [-ExpandEnvironmentVariables] [<CommonParameters>]
```
