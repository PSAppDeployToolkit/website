...
The `Invoke-ADTFunctionErrorHandler` function handles errors within ADT functions by logging the error message and optionally passing through the error record.
...
```yaml
Type: String
Parameter Sets: None, DisableErrorResolving, AdditionalResolveErrorProperties, ResolveErrorProperties
Aliases:
...
[https://psappdeploytoolkit.com/docs/reference/functions/Invoke-ADTFunctionErrorHandler](https://psappdeploytoolkit.com/docs/reference/functions/Invoke-ADTFunctionErrorHandler)

[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Invoke-ADTFunctionErrorHandler.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Invoke-ADTFunctionErrorHandler.ps1)
