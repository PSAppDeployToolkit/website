...
By using the PersistPrompt switch, the dialog will return to the center of the screen every couple of seconds, specified in the `config.psd1` file, so the user cannot ignore it by dragging it aside.
