...
description: 'Show a welcome dialog prompting the user with information about the deployment and actions to be performed before the deployment can begin.'
keywords:
  - PSADT
  - PSAppDeployToolkit
  - PowerShell
