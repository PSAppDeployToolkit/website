...
```powershell
Show-ADTInstallationWelcome [-WindowLocation <DialogPosition>] [-PersistPrompt] [-ContinueOnProcessClosure]
 [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize] [-CustomMessage] [-CustomMessageText <String>]
 [-PassThru] -Title <String> -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-Silent] [-BlockExecution] [-CheckDiskSpace]
 -Title <String> -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-Silent] [-BlockExecution] -Title <String>
 -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton]
 [-AllowDeferCloseProcesses] -ForceCloseProcessesCountdown <TimeSpan> [-DeferTimes <UInt32>]
 ...
 [-NotTopMost] [-AllowMove] [-AllowMinimize] [-CustomMessage] [-CustomMessageText <String>] [-CheckDiskSpace]
 [-PassThru] -Title <String> -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton]
 ...
 [-DeferDays <Double>] [-DeferDeadline <DateTime>] [-DeferRunInterval <TimeSpan>]
 [-WindowLocation <DialogPosition>] [-BlockExecution] [-PromptToSave] [-PersistPrompt] [-MinimizeWindows]
 [-NotTopMost] [-AllowMove] [-AllowMinimize] [-CustomMessage] [-CustomMessageText <String>] [-PassThru]
 -Title <String> -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton]
 [-AllowDeferCloseProcesses] -CloseProcessesCountdown <TimeSpan> [-DeferTimes <UInt32>] [-DeferDays <Double>]
 [-DeferDeadline <DateTime>] [-DeferRunInterval <TimeSpan>] [-WindowLocation <DialogPosition>]
 [-BlockExecution] [-PromptToSave] [-PersistPrompt] [-MinimizeWindows] [-NotTopMost] [-AllowMove]
 [-AllowMinimize] [-CustomMessage] [-CustomMessageText <String>] [-CheckDiskSpace] [-PassThru] -Title <String>
 -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton]
 ...
 [-DeferDeadline <DateTime>] [-DeferRunInterval <TimeSpan>] [-WindowLocation <DialogPosition>]
 [-BlockExecution] [-PromptToSave] [-PersistPrompt] [-MinimizeWindows] [-NotTopMost] [-AllowMove]
 [-AllowMinimize] [-CustomMessage] [-CustomMessageText <String>] [-PassThru] -Title <String> -Subtitle <String>
 [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton]
 [-AllowDeferCloseProcesses] -ForceCountdown <TimeSpan> [-DeferTimes <UInt32>] [-DeferDays <Double>]
 [-DeferDeadline <DateTime>] [-DeferRunInterval <TimeSpan>] [-WindowLocation <DialogPosition>]
 [-BlockExecution] [-PromptToSave] [-PersistPrompt] [-MinimizeWindows] [-NotTopMost] [-AllowMove]
 [-AllowMinimize] [-CustomMessage] [-CustomMessageText <String>] [-CheckDiskSpace] [-PassThru] -Title <String>
 -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton]
 ...
 [-PersistPrompt] [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize] [-CustomMessage]
 [-CustomMessageText <String>] [-CheckDiskSpace] [-PassThru] -Title <String> -Subtitle <String>
 [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton]
 ...
 [-DeferRunInterval <TimeSpan>] [-WindowLocation <DialogPosition>] [-BlockExecution] [-PromptToSave]
 [-PersistPrompt] [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize] [-CustomMessage]
 [-CustomMessageText <String>] [-PassThru] -Title <String> -Subtitle <String> [-RequiredDiskSpace <UInt32>]
 [<CommonParameters>]
```
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton] [-AllowDefer]
 -ForceCloseProcessesCountdown <TimeSpan> [-DeferTimes <UInt32>] [-DeferDays <Double>]
 [-DeferDeadline <DateTime>] [-DeferRunInterval <TimeSpan>] [-WindowLocation <DialogPosition>]
 [-BlockExecution] [-PromptToSave] [-PersistPrompt] [-ContinueOnProcessClosure] [-MinimizeWindows]
 [-NotTopMost] [-AllowMove] [-AllowMinimize] [-CustomMessage] [-CustomMessageText <String>] [-CheckDiskSpace]
 [-PassThru] -Title <String> -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton] [-AllowDefer]
 -CloseProcessesCountdown <TimeSpan> [-DeferTimes <UInt32>] [-DeferDays <Double>] [-DeferDeadline <DateTime>]
 [-DeferRunInterval <TimeSpan>] [-WindowLocation <DialogPosition>] [-BlockExecution] [-PromptToSave]
 [-PersistPrompt] [-ContinueOnProcessClosure] [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize]
 [-CustomMessage] [-CustomMessageText <String>] [-CheckDiskSpace] [-PassThru] -Title <String>
 -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton] [-AllowDefer]
 ...
 [-DeferRunInterval <TimeSpan>] [-WindowLocation <DialogPosition>] [-BlockExecution] [-PromptToSave]
 [-PersistPrompt] [-ContinueOnProcessClosure] [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize]
 [-CustomMessage] [-CustomMessageText <String>] [-PassThru] -Title <String> -Subtitle <String>
 [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton] [-AllowDefer]
 -ForceCountdown <TimeSpan> [-DeferTimes <UInt32>] [-DeferDays <Double>] [-DeferDeadline <DateTime>]
 [-DeferRunInterval <TimeSpan>] [-WindowLocation <DialogPosition>] [-BlockExecution] [-PromptToSave]
 [-PersistPrompt] [-ContinueOnProcessClosure] [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize]
 [-CustomMessage] [-CustomMessageText <String>] [-CheckDiskSpace] [-PassThru] -Title <String>
 -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
...
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton] [-AllowDefer]
 ...
 [-WindowLocation <DialogPosition>] [-BlockExecution] [-PromptToSave] [-PersistPrompt]
 [-ContinueOnProcessClosure] [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize] [-CustomMessage]
 [-CustomMessageText <String>] [-CheckDiskSpace] [-PassThru] -Title <String> -Subtitle <String>
 [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton]
 -ForceCloseProcessesCountdown <TimeSpan> [-WindowLocation <DialogPosition>] [-BlockExecution] [-PromptToSave]
 [-PersistPrompt] [-ContinueOnProcessClosure] [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize]
 [-CustomMessage] [-CustomMessageText <String>] [-CheckDiskSpace] [-PassThru] -Title <String>
 -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationWelcome -CloseProcesses <ProcessDefinition[]> [-HideCloseButton]
 -CloseProcessesCountdown <TimeSpan> [-WindowLocation <DialogPosition>] [-BlockExecution] [-PromptToSave]
 [-PersistPrompt] [-ContinueOnProcessClosure] [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize]
 [-CustomMessage] [-CustomMessageText <String>] [-CheckDiskSpace] [-PassThru] -Title <String>
 -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationWelcome [-AllowDefer] -ForceCountdown <TimeSpan> [-DeferTimes <UInt32>]
 [-DeferDays <Double>] [-DeferDeadline <DateTime>] [-DeferRunInterval <TimeSpan>]
 [-WindowLocation <DialogPosition>] [-PersistPrompt] [-ContinueOnProcessClosure] [-MinimizeWindows]
 [-NotTopMost] [-AllowMove] [-AllowMinimize] [-CustomMessage] [-CustomMessageText <String>] [-CheckDiskSpace]
 [-PassThru] -Title <String> -Subtitle <String> [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationWelcome [-Silent] [-CheckDiskSpace] -Title <String> -Subtitle <String>
 [-RequiredDiskSpace <UInt32>] [<CommonParameters>]
```
...
```powershell
Show-ADTInstallationWelcome [-Silent] -Title <String> -Subtitle <String> [-RequiredDiskSpace <UInt32>]
 [<CommonParameters>]
```
...
Show-ADTInstallationWelcome [-WindowLocation <DialogPosition>] [-PersistPrompt] [-ContinueOnProcessClosure]
 [-MinimizeWindows] [-NotTopMost] [-AllowMove] [-AllowMinimize] [-CustomMessage] [-CustomMessageText <String>]
 [-CheckDiskSpace] [-PassThru] -Title <String> -Subtitle <String> [-RequiredDiskSpace <UInt32>]
 [<CommonParameters>]
```
...
By using the PersistPrompt switch, the dialog will return to the center of the screen at the interval specified in the `config.psd1` file, so the user cannot ignore it by dragging it aside.
...
One or more processes to close.
Specify multiple processes separated by a comma.
Provide either the bare process name (do not include the `.exe`), or the full path to a specific executable if you need to distinguish between two processes that share the same name (for example, two different vendors' `javaw.exe`).
Wildcards (`*`) are supported in either form.
Specify custom descriptions to show to the end user like this: `@{ Name = 'winword'; Description = 'Microsoft Office Word' }, @{ Name = 'excel'; Description = 'Microsoft Office Excel' }`.
The `Description` property is purely cosmetic - it does not filter or restrict which running processes are matched.
Use the full path form of `Name` if you need to target one specific executable.
...
Option to provide a countdown until the specified applications are automatically closed.
...
Option to provide a countdown until the specified applications are automatically closed regardless of whether deferral is allowed.
Accepts TimeSpan objects, but also interprets numerical values as seconds.
...
Specify whether to prevent the user from launching processes/applications, specified in `-CloseProcesses`, during the deployment.
This parameter utilizes the `Block-ADTAppExecution` function to prevent the user from launching the specified processes.
...
Specify whether to make the prompt persist, reappearing in the specified `-WindowLocation` at the interval specified in the `config.psd1` file.
...
The process descriptions are retrieved via `Get-Process`, with a fallback on the process name if no description is available.
Alternatively, you can specify the description yourself by providing a hashtable that is converted to a ProcessDefinition object, e.g., `@{ Name = 'winword'; Description = 'Microsoft Word' }`

The dialog box will time out after the timeout specified in the `config.psd1` file (default 55 minutes) to prevent Intune/SCCM deployments from timing out and returning a failure code.
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Show-ADTInstallationWelcome.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Show-ADTInstallationWelcome.ps1)
