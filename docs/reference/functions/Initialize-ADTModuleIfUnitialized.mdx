---
id: Initialize-ADTModuleIfUnitialized
title: Initialize-ADTModuleIfUnitialized
hide_title: false
...
```powershell
Initialize-ADTModuleIfUnitialized [-Cmdlet] <PSCmdlet> [[-ScriptDirectory] <String[]>]
...
[https://psappdeploytoolkit.com/docs/reference/functions/Initialize-ADTModuleIfUnitialized](https://psappdeploytoolkit.com/docs/reference/functions/Initialize-ADTModuleIfUnitialized)
