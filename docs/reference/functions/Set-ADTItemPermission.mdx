...
```powershell
Set-ADTItemPermission -LiteralPath <String> -AccessControlList <FileSystemSecurity> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Set-ADTItemPermission -LiteralPath <String> [-EnableInheritance] [-RemoveExplicitRules] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Set-ADTItemPermission -LiteralPath <String> -User <String[]> -Permission <FileSystemRights>
 ...
 [-Method <String>] [-DisableInheritance] [-WhatIf] [-Confirm] [<CommonParameters>]
```
