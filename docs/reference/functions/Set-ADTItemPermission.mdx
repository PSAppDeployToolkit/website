...
```powershell
Set-ADTItemPermission -LiteralPath <String> -AccessControlList <FileSystemSecurity> [<CommonParameters>]
```

### EnableInheritance

```powershell
Set-ADTItemPermission -LiteralPath <String> [-EnableInheritance] [-RemoveExplicitRules] [<CommonParameters>]
```
...
Set-ADTItemPermission -LiteralPath <String> -User <String[]> -Permission <FileSystemRights>
 ...
 [-Method <String>] [-DisableInheritance] [<CommonParameters>]
```
