...
Set-ADTActiveSetup -StubExePath <String> [-Arguments <String>] [-Wow6432Node]
 ...
 -Key <String> -Description <String> [<CommonParameters>]
```

### CreateNoExecute

```powershell
Set-ADTActiveSetup [-Arguments <String>] [-Wow6432Node] [-ExecutionPolicy <ExecutionPolicy>]
 [-Version <String>] [-Locale <String>] [-DisableActiveSetup] [-NoExecuteForCurrentUser] -Key <String>
 [<CommonParameters>]
```
