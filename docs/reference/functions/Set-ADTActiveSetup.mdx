...
```powershell
Set-ADTActiveSetup -StubExePath <String> [-ArgumentList <String[]>] [-Wow6432Node]
 [-ExecutionPolicy <ExecutionPolicy>] [-Version <String>] [-Locale <String>] [-DisableActiveSetup] [-PassThru]
 [-WhatIf] [-Confirm] -Key <String> -Description <String> [<CommonParameters>]
```
...
Set-ADTActiveSetup -StubExePath <String> [-ArgumentList <String[]>] [-Wow6432Node]
 ...
 [-NoExecuteForCurrentUser] [-WhatIf] [-Confirm] -Key <String> -Description <String> [<CommonParameters>]
```

### Purge

```powershell
Set-ADTActiveSetup [-Wow6432Node] [-PurgeActiveSetupKey] [-WhatIf] [-Confirm] -Key <String>
 [<CommonParameters>]
```
...
Due to a Windows Active Setup/registry limitation, the entry is not triggered if the Version value contains a sequence of more than 8 digits without separators.
Use separators such as commas in the version string (for example, `1,0,20240101`) to break up long digit sequences and work around this limitation.

Note: Do not use this parameter if it is not necessary.
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Set-ADTActiveSetup.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Set-ADTActiveSetup.ps1)
