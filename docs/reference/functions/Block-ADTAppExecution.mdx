...
The `Block-ADTAppExecution` function is called when you pass the `-BlockExecution` parameter to the `Show-ADTInstallationWelcome` function.
...
[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Block-ADTAppExecution.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Block-ADTAppExecution.ps1)
