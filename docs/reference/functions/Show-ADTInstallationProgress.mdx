...
The `Show-ADTInstallationProgress` function creates a UI window in a separate thread to display a marquee style progress ellipse with a custom message that can be updated.
