---
id: Start-ADTMsiProcessAsUser
title: Start-ADTMsiProcessAsUser
hide_title: false
...
```powershell
Start-ADTMsiProcessAsUser [-Username <NTAccount>] [-Action <String>] -FilePath <String>
 [-ArgumentList <String[]>] [-AdditionalArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-Transforms <String[]>] [-Patches <String[]>] [-UseLinkedAdminToken]
 [-UseHighestAvailableToken] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables]
 [-DenyUserTermination] [-LoggingOptions <String>] [-LogFileName <String>] [-RepairMode <String>]
 [-RepairFromSource] [-SkipMSIAlreadyInstalledCheck] [-IncludeUpdatesAndHotfixes]
 [-PriorityClass <ProcessPriorityClass>] [-ContinueWhenNoUserLoggedOn] [-NoDesktopRefresh] [-NoWait]
...
Start-ADTMsiProcessAsUser [-Username <NTAccount>] [-Action <String>] -FilePath <String>
 ...
 [-ExitOnProcessFailure] [-ContinueWhenNoUserLoggedOn] [-NoDesktopRefresh] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Start-ADTMsiProcessAsUser [-Username <NTAccount>] [-Action <String>] -ProductCode <Guid>
 [-ArgumentList <String[]>] [-AdditionalArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-Transforms <String[]>] [-Patches <String[]>] [-UseLinkedAdminToken]
 [-UseHighestAvailableToken] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables]
 [-DenyUserTermination] [-LoggingOptions <String>] [-LogFileName <String>] [-RepairMode <String>]
...
```powershell
Start-ADTMsiProcessAsUser [-Username <NTAccount>] [-Action <String>]
 -InstalledApplication <InstalledApplication> [-ArgumentList <String[]>] [-AdditionalArgumentList <String[]>]
 [-SecureArgumentList] [-WorkingDirectory <String>] [-Transforms <String[]>] [-Patches <String[]>]
 [-UseLinkedAdminToken] [-UseHighestAvailableToken] [-InheritEnvironmentVariables]
 [-ExpandEnvironmentVariables] [-DenyUserTermination] [-LoggingOptions <String>] [-LogFileName <String>]
 [-RepairMode <String>] [-RepairFromSource] [-SkipMSIAlreadyInstalledCheck] [-IncludeUpdatesAndHotfixes]
 [-PriorityClass <ProcessPriorityClass>] [-ContinueWhenNoUserLoggedOn] [-NoDesktopRefresh] [-NoWait]
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Start-ADTMsiProcessAsUser [-Username <NTAccount>] [-Action <String>]
 ...
 [-PriorityClass <ProcessPriorityClass>] [-ExitOnProcessFailure] [-ContinueWhenNoUserLoggedOn]
 [-NoDesktopRefresh] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION

The `Start-ADTMsiProcessAsUser` function utilizes msiexec.exe to handle various operations on MSI and MSP files, as well as MSI product codes.
...
```yaml
Type: String
Parameter Sets: FilePath_NoWait, FilePath
Aliases:
...
```yaml
Type: Guid
Parameter Sets: ProductCode_NoWait, ProductCode
Aliases:
...
Parameter Sets: InstalledApplication_NoWait, InstalledApplication
Aliases:
...
```yaml
Type: Int32[]
Parameter Sets: FilePath, ProductCode, InstalledApplication
Aliases:
...
```yaml
Type: SwitchParameter
Parameter Sets: FilePath_NoWait, ProductCode_NoWait, InstalledApplication_NoWait
Aliases:
...
[https://psappdeploytoolkit.com/docs/reference/functions/Start-ADTMsiProcessAsUser](https://psappdeploytoolkit.com/docs/reference/functions/Start-ADTMsiProcessAsUser)

[https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Start-ADTMsiProcessAsUser.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Start-ADTMsiProcessAsUser.ps1)
