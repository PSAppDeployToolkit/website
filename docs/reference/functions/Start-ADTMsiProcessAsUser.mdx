...
```powershell
Start-ADTMsiProcessAsUser [-Action <String>] -FilePath <String> [-ArgumentList <String[]>]
...
```powershell
Start-ADTMsiProcessAsUser [-Action <String>] -ProductCode <Guid> [-ArgumentList <String[]>]
 [-AdditionalArgumentList <String[]>] [-SecureArgumentList] [-WorkingDirectory <String>]
 [-Transforms <String[]>] [-Patches <String[]>] [-Username <NTAccount>] [-UseLinkedAdminToken]
 [-UseHighestAvailableToken] [-InheritEnvironmentVariables] [-ExpandEnvironmentVariables]
 [-LoggingOptions <String>] [-LogFileName <String>] [-RepairMode <String>] [-RepairFromSource]
...
```powershell
Start-ADTMsiProcessAsUser [-Action <String>] -InstalledApplication <InstalledApplication>
 [-ArgumentList <String[]>] [-AdditionalArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-Transforms <String[]>] [-Patches <String[]>] [-Username <NTAccount>]
