...
| Setting                           | Description                                                      |
|:----------------------------------|:-----------------------------------------------------------------|
| Toolkit.CachePath                 | Specifies the cache path for the toolkit.                        |
| Toolkit.CompressLogs              | Determines if logs should be compressed.                         |
...
| UI.DialogStyle                      | Sets the style for dialogs.                       |
...
| UI.PromptToSaveTimeout              | Sets the timeout for prompt to save.              |
