...
| Assets.LogoDark | Specifies the logo asset.   |

## Toolkit Settings
| Setting                           | Description                                                      |
|:----------------------------------|:-----------------------------------------------------------------|
| Toolkit.CachePath                 | Specifies where the toolkit caches files.                        |
| Toolkit.CompanyName               | Specifies the company name to use in default dialog subtitles.   |
...
| Toolkit.LogHostOutputToStdStreams | Logs host output direct to stdout/stderr.                        |
...
| Toolkit.SessionDetection          | Auto-change DeployMode for session zero operations.              |
