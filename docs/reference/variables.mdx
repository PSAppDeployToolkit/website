...
In addition, the variables specific to a particular deployment, such as $appName and $appVersion, have now been moved inside of this ADTSession object.

For more information, see the [ADTSession Object](./adtsession-object) page.
...
| Variable                    | Description                                                                                                  |
| :-------------------------- | ------------------------------------------------------------------------------------------------------------ |
| `envOfficeBitness`          | Architecutre of current Office installation, e.g. x86 or x64                                                 |
