...
| Setting | Description |
| :------ | :---------- |
| `Start.Install` | Text displayed for the start of an installation. |
| `Start.Repair` | Text displayed for the start of a repair. |
| `Start.Uninstall` | Text displayed for the start of an uninstallation. |
| `Complete.Install` | Text displayed for successful completion of an installation. |
| `Complete.Repair` | Text displayed for successful completion of a repair. |
| `Complete.Uninstall` | Text displayed for successful completion of an uninstallation. |
| `RestartRequired.Install` | Text displayed when an installation completes and requires a restart. |
| `RestartRequired.Repair` | Text displayed when a repair completes and requires a restart. |
| `RestartRequired.Uninstall` | Text displayed when an uninstallation completes and requires a restart. |
| `FastRetry.Install` | Text displayed for a fast retry of an installation. |
| `FastRetry.Repair` | Text displayed for a fast retry of a repair. |
| `FastRetry.Uninstall` | Text displayed for a fast retry of an uninstallation. |
| `Error.Install` | Text displayed for a failed installation. |
| `Error.Repair` | Text displayed for a failed repair. |
| `Error.Uninstall` | Text displayed for a failed uninstallation. |
...
| `Subtitle.Install` | Subtitle for Fluent dialogs during an installation. |
| `Subtitle.Repair` | Subtitle for Fluent dialogs during a repair. |
| `Subtitle.Uninstall` | Subtitle for Fluent dialogs during an uninstallation. |
...
| Setting | Description |
| :------ | :---------- |
| `Message.Install` | Default message displayed during an installation. |
| `Message.Repair` | Default message displayed during a repair. |
| `Message.Uninstall` | Default message displayed during an uninstallation. |
| `MessageDetail.Install` | Default detail message displayed during an installation. |
| `MessageDetail.Repair` | Default detail message displayed during a repair. |
| `MessageDetail.Uninstall` | Default detail message displayed during an uninstallation. |
| `Subtitle.Install` | Subtitle for Fluent dialogs during an installation. |
| `Subtitle.Repair` | Subtitle for Fluent dialogs during a repair. |
| `Subtitle.Uninstall` | Subtitle for Fluent dialogs during an uninstallation. |
