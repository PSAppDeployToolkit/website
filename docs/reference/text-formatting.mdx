...
Rendered, that message looks like this:

<ThemedImage
  alt="The Office 365 deployment notice rendered in a dialog, with bold, italic, accent and hyperlink formatting applied"
  className="markdown_image"
  sources={{
    light: require('../images/prompt_formatting_light.png').default,
    dark: require('../images/prompt_formatting_dark.png').default,
  }}
/>
