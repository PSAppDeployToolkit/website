...
If you leave the **AppName** blank, [Zero Config](/docs/understanding-the-layout/zero-config-deployment) will kick in, auto-mount any WIM file found and install the MSI found within.
