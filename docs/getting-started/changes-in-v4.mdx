...
- The standard toolkit environment variables (e.g. `$envProgramFiles`) will be available once an [ADTSession](/docs/reference/adtsession-object) has been started, or the `Export-ADTEnvironmentTableToSessionState` command has been run.
