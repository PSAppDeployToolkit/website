...
The [Creating a new deployment](/docs/getting-started/create-a-new-deployment) page details how to create a v3-compatible deployment template, or to download one from GitHub.
