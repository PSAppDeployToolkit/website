...
If you have not already done so, be sure to familiarise yourself with the numerous [changes](../getting-started/changes-in-v4) in v4.

## Using v4 in v3 Compatibility Mode

The [Creating a new deployment](../getting-started/create-a-new-deployment) page details how to create a v3-compatible deployment template, or to download one from GitHub.
...
The [Downloading](../getting-started/download) page covers how to download and install this additional module.
...
- Customised assets/banners are not currently copied over.
