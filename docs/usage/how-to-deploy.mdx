...
- Use `ServiceUI.exe` or a helper script if you need to show dialogs in **Intune** deployments: [Invoke-ServiceUI.ps1](https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/tree/main/examples/ServiceUI)
...
Deploy an application for uninstallation using PowerShell x86, suppressing the console window, and in silent mode.
...
Specify the installation mode (Install, Uninstall, or Repair).
