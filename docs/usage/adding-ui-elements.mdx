...
The progress message can be updated dynamically to show the installation stage or display custom messages, using the [Show-ADTInstallationProgress](/docs/reference/functions/Show-ADTInstallationProgress) function.
...
A custom prompt with PSAppDeployToolkit branding can be displayed using [Show-ADTInstallationPrompt](/docs/reference/functions/Show-ADTInstallationPrompt). The title and text can be customized, and up to 3 buttons can be included.
